...
## Project Structure
    ...
    ├── testapiautodatamod_110850  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_110850`
...
2. Clone this repo and `cd testapiautodatamod_110850`
